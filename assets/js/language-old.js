...
const translations = {
    ...
    en: {
        ...
        aboutdesc: "Established in 2018, ReMex empowers overseas Vietnamese and businesses by making global financial flows seamless, secure, and cost-effective. We go where Vietnamese go.",
        speedtitle: "Speed",
        speed_desc: "Near real-time transactions",
        cost_title: "Affordability",
        cost_desc: "Competitive rates, no hidden fees",
        safety_title: "Security",
        safety_desc: "High level of legal compliance and security infrastructure.",
        

        // Solutions (New)
        solutionTitle: "Comprehensive Cross-Border Solutions",
        traditionalRemittanceTitle: "Traditional Remittance",
        traditionalRemittanceDesc:"Fast and secure transfers to Vietnam via Single API integration, optimizing speed and cost.",
        salaryRemittanceTitle: "Advance Salary Remittance",
        salaryRemittanceDesc:"Enables families in Vietnam to access part of overseas workers' earned wages early in emergencies, through partnerships with payroll and EWA providers.",
        investmentRemittanceTitle: "Investment Remittance",
        investmentRemittanceDesc:"Connects overseas Vietnamese with opportunities to invest in Vietnamese stocks, real estate, and startups with full compliance and ease.",
        touristRemittanceTitle: "Remittance for International Travelers",
        touristRemittanceDesc:"Real-time currency exchange and merchant settlements in Vietnam via partnerships with global travel card issuers.",

        // Infrastructure (New)
        infrastructureTitle: "One Infrastructure – Powering All Financial Flows",
        singleApiTitle: "Single API Integration",
        singleApiDesc: "Seamless connection to Vietnam's banking system through one API.",
        endToEndTitle: "End-to-End Process",
        endToEndDesc: "Full management of the entire transaction cycle",
        complianceReadyTitle: "Compliance Ready",
        complianceReadyDesc: "Regulatory compliance ensured across all markets",
        ...
        // Hero section split keys
        bridgeTitle: "Financial Bridge",
        bridgeSubtitle1: "for Overseas Vietnamese",
        bridgeSubtitle2: "and Global Businesses",
        paymentSolution: "Cross-border payment solutions and remittances",
        paymentDescription: "with strategic financial consulting – safe, fast,",
        ...
        noComplexity: "No dealing with multiple complex parties",
        trustedIntermediary: "ReMex acts as your trusted intermediary handling everything",
        clearTracking: "Clear and easy transaction tracking",
        quickSupport: "Fast support for any issues",
        ...
        testimonialsSubtitle: "Real experiences from the ReMex community",
        ...
        appSubtitle: "Anytime, anywhere access",
        ...
        notificationsDesc: "Stay updated every step",

        // CTA Section
        ctaTitle: "Wherever Vietnamese People Go – ReMex Follows",
        ...
        // Footer
        footerDesc: "ReMex Global Payment Services JSC – Your trusted partner for cross-border payments, remittances, and strategic consulting in Vietnam.",
        company: "Company",
        recruitment: "Careers",
        news: "News",
        products: "Products",
